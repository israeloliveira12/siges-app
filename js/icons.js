...
const Icons = {
  ...
  calendar: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="4.5" width="18" height="16" rx="1.5"/><path d="M3 9.5h18M8 2.5v4M16 2.5v4"/></svg>`,
  ...
  whatsapp: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z"/><path d="M15.8 14.2c-.4.4-1.1.6-1.7.4a7.5 7.5 0 0 1-4.6-4.6c-.2-.6 0-1.3.4-1.7l.4-.4c.3-.3.4-.7.2-1.1L10 5.4c-.2-.5-.8-.6-1.2-.3-.6.5-1.3 1.3-1.5 2.2-.3 1.5.1 3.6 2.4 5.9 2.3 2.3 4.4 2.7 5.9 2.4.9-.2 1.7-.9 2.2-1.5.3-.4.2-1-.3-1.2l-1.4-.8c-.4-.2-.8-.1-1.1.2Z"/></svg>`,
};
