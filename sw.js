...
const CACHE_NAME = 'siges-cache-v73';
...
const FILES_TO_CACHE = [
  ...
  './js/screens/gerente-lancamentos.js',
  ...
  './js/screens/plataforma-inicio.js',
  './js/screens/plataforma-empresas.js',
  './js/screens/plataforma-planos.js',
  './js/screens/plataforma-cobrancas.js',
  './js/screens/plataforma-comunicados.js',
  './js/screens/plataforma-metricas.js',
  './js/screens/plataforma-configuracoes.js',
  './js/screens/plataforma-backup.js',
  './js/main.js',
  './icons/icon-192.png',
  './icons/icon-512.png',
